...
def generate_artwork_info(artist, title):
    ...
    model="gpt-4",  # Use GPT-4 instead of text-davinci-002
    messages=[
        {
            "role": "system",
            "content": "You are a helpful art critic and poet. Provide deep interpretations and insights about artworks.",
        },
        {
            "role": "user",
            "content": f"Interpret '{title}' by {artist}. Write 3 words this artwork inspires you. Make it short if possible in bullet points. Include a short section that explains how it could resonate with our current society.",
        },
    ],
    max_tokens=150,
    n=1,
